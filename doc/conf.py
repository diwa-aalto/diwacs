# -*- coding: utf-8 -*-
#
# Chimaira documentation build configuration file, created by
...
sys.path.insert(0,
            os.path.abspath(r'C:\Users\Kristian\Documents\workspace\diwacs'))

# Import vars for application name and version, this needs to be after
# sys.path.insert
import diwavars
